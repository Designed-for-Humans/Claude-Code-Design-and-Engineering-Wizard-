...
echo ""
echo "  2. Connect the MCP server (recommended):"
echo -e "     ${YELLOW}claude mcp add design-system -t http \\"
echo -e "       https://zncwlnoobrkxfghglpep.supabase.co/functions/v1/design-system-mcp/mcp${NC}"
echo ""
